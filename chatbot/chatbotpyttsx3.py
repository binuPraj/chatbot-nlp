...
st.set_page_config(page_title="UFO Nepal Chatbot(Project)", page_icon="🧵", layout="centered", initial_sidebar_state="collapsed")
st.markdown("""
    <style>
        body {
...
st.title("🧵 UFO Nepal Website Chatbot")
...
# Form for user to input name and training epochs
...
# If form is submitted, train the chatbot
if submitted:
